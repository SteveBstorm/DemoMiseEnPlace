/*
Script de déploiement pour DemoMovie
...
GO
:setvar DatabaseName "DemoMovie"
:setvar DefaultFilePrefix "DemoMovie"
...
GO
PRINT N'Création de Table [dbo].[Actors]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_CASTING_Movie]...';


GO
ALTER TABLE [dbo].[Casting]
    ADD CONSTRAINT [FK_CASTING_Movie] FOREIGN KEY ([MovieId]) REFERENCES [dbo].[Movie] ([Id]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_CASTING_Actors]...';


GO
ALTER TABLE [dbo].[Casting]
    ADD CONSTRAINT [FK_CASTING_Actors] FOREIGN KEY ([ActorId]) REFERENCES [dbo].[Actors] ([Id]);
